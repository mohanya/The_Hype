  ...
  module Rails
    module Controller
      ...
      def create_facebook_session
        RAILS_DEFAULT_LOGGER.info "XXX   create_facebook_session"
      ...
      def set_facebook_session
        RAILS_DEFAULT_LOGGER.info "XXX set_facebook_session"
      ...
      def session_already_secured?
        RAILS_DEFAULT_LOGGER.info "XXX   session_already_secured"
      ...
      def valid_session_key_in_session?
        RAILS_DEFAULT_LOGGER.info "XXX     valid_session_key_in_session (normally returns false as session[:facebook_session] nil)"
      ...
      def secure_with_cookies!
        RAILS_DEFAULT_LOGGER.info "XXX     secure_with_cookies!"
          parsed = {}
      ...
      def secure_with_token!
        RAILS_DEFAULT_LOGGER.info "XXX     secure_with_token!"
      ...
      def secure_with_facebook_params!
        RAILS_DEFAULT_LOGGER.info "XXX     secure_with_facebook_params!"
      ...
      def new_facebook_session
        RAILS_DEFAULT_LOGGER.info "XXX       new_facebook_session"
