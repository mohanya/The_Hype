...
describe ApplicationHelper do
  ...
  describe "formatting time" do
    it "should return nil when passed nil" do
      date_string(nil).should be_nil
      date_time_string(nil).should be_nil
    end
    
    it "should render date only" do
      date_string(Time.parse('2008-10-23')).should == "10/23/08"
    end
    
    it "should render date and time" do
      date_time_string(Time.parse('2008-10-23 23:35:29')).should == "10/23/08 @ 11:35:29 PM"
    end
  end
  ...
  describe 'page title' do
    ...
    it "should use forwards title if non available so far" do
      self.should_receive(:partial_title).and_return(nil)
  ...
  describe "miscellaneous" do
    ...
    it "should use id if controller is pages" do
      body_id("pages", "home").should == "home"
    end
    
    it "should use controller when it is not pages" do
      body_id("songs", "index").should == "songs"
    end
  end
end
