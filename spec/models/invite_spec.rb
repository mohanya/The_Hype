...
describe Invite do
  ...
  it "should not add an invite for an existing user" do
    user = users(:quentin)
    invite = Factory.build(:invite, :email => "quentin@example.com")
